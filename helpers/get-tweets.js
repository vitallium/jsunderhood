// taken from https://github.com/varya/catunderhood/commit/437725c2c4af81eda7ffc1e386ffd2ff260c5b71
...
const getNextOptions = (options, tweets) =>
  isEmpty(tweets) ? options : merge(options, { max_id: pipe(last, prop('id_str'), dec)(tweets) });
